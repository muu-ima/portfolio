  ...
  return (
    <>
      ...
      >
        ...
        />
        <span className="absolute bottom-3 right-3 rounded-[var(--portfolio-radius)] bg-zinc-950/90 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-white opacity-0 transition group-hover:opacity-100 group-focus-visible:opacity-100">
          View
        </span>
      </button>
