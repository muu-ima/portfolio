...
このディレクトリは、ポートフォリオで紹介しているアプリやシステムの設計メモです。

## Documents

- [tools-hub](./tools-hub.md)
...
それぞれのプロジェクトは、見た目の完成度だけでなく、裏側の設計や業務の読み解きに価値があります。

- tools-hub: 越境ECの利益計算と発送情報管理
...
- tools-hub は、複雑な税制、為替、送料、手数料を日々使える計算画面に落とし込めている
